...
LABEL maintainer = "Song hui <ifournight@gmail.com>"
...
RUN mkdir -p /usr/share/fonts/opentype && \
    ...
    apt-get update && apt-get install unzip && unzip SourceHanSerifSC_EL-M.zip && \
    apt-get install fontconfig && fc-cache -f -v
